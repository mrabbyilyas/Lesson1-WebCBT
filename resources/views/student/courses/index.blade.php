            ...
            <div class="course-list-container flex flex-col px-5 mt-[30px] gap-[30px]">
                ...
                @forelse ($my_courses as $course)
                    <div class="list-items flex flex-nowrap justify-between pr-10">
                        ...
                        @if($course->questions()->count() > 0) <!-- Cek jika ada soal -->
                            ...
                            @endif  
                        @else
                            <!-- Jika tidak ada soal, tampilkan tombol atau pesan lain -->
                            <span class="w-full h-[41px] p-[10px_20px] bg-gray-600 rounded-full font-bold text-sm text-white text-center">Wait</span>
                        @endif
                        </div>
                    </div>
                @empty
