                    ...
                    @forelse ($students as $student)
                        <div class="student-card w-full flex items-center justify-between p-4 border border-[#EEEEEE] rounded-[20px]">
                            ...
                            <div class="flex items-center gap-[14px]">
                                ...
                                @else
                                    <p class="p-[6px_10px] rounded-[10px] bg-slate-400 font-bold text-xs text-white outline-slate-400 outline-dashed outline-[2px] outline-offset-[4px] mr-[6px]">Not Started</p>
                                @endif
                            </div>
                        </div>
                    @empty
