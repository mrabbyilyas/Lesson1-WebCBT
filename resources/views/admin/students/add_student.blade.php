...
<head>
    ...
    <link href="{{asset('css/output.css')}}" rel="stylesheet" rel="stylesheet">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <div class="flex flex-col gap-10 px-5 mt-5">
                <div class="breadcrumb flex items-center gap-[30px]">
                    ...
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="{{route('dashboard.course.course_students.index', $course)}}" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Course Students</a>
                    <span class="text-[#7F8190] last:text-[#0A090B]">/</span>
                    <a href="#" class="text-[#7F8190] last:text-[#0A090B] last:font-semibold">Add Students</a>
                </div>
            </div>
                ...
                <div class="flex gap-6 items-center">
                    <div class="w-[150px] h-[150px] flex shrink-0 relative overflow-hidden">
                        ...
                        @elseif($course->category->name == 'Programming')
                            <p class="p-[8px_16px] rounded-full bg-[#EAE8FE] font-bold text-sm text-[#6436F1] absolute bottom-0 transform -translate-x-1/2 left-1/2 text-nowrap">{{$course->category->name}}</p>
                        @elseif($course->category->name == 'Unreal Engine')
                            <p class="p-[8px_16px] rounded-full bg-[#D5EFFE] font-bold text-sm text-[#066DFE] absolute bottom-0 transform -translate-x-1/2 left-1/2 text-nowrap">{{$course->category->name}}</p>
                        @endif
                    </div>
