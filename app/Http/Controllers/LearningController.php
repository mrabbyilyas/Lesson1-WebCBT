...
class LearningController extends Controller
{
    ...
    public function index(){
        ...
        foreach($my_courses as $course){
            ...
            if($answeredQuestionsCount < $totalQuestionsCount){
                $firstUnasweredQuestion = CourseQuestion::where('course_id', $course->id)
                ...
                $course->nextQuestionId = $firstUnasweredQuestion ? $firstUnasweredQuestion->id : null;
            }
    ...
    public function learning_rapport(Course $course){
        ...
        $passed = $correctAnswersCount == $totalQuestionsCount;
